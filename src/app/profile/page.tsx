  ...
  useEffect(() => {
    const unsubscribe = onAuthStateChanged(auth, async (user) => {
      ...
      try {
        ...
        console.log("取得件数:", feedbackSnapshot.docs.length);
        ...
        console.log("取得データ:", feedbackList);
      ...
      <div className="mx-auto max-w-4xl rounded-2xl bg-white p-6 shadow">
        ...
        {profile && (
          <div className="mb-8 rounded-xl border p-4">
            <h2 className="mb-3 text-xl font-bold">基本情報</h2>
            <p>名前: {profile.name}</p>
        ...
        {diagnostic && (
          <div className="mb-8 rounded-xl border p-4">
            ...
            <div className="mt-4">
              <p className="font-semibold">強み</p>
            ...
            <div className="mt-4">
              <p className="font-semibold">弱み</p>
              <ul className="list-disc pl-5">
            ...
            <div className="mt-4">
              <p className="font-semibold">特性</p>
              <ul className="list-disc pl-5">
          ...
          <div className="rounded-xl border p-4">
            ...
            {conflictMatches.length > 0 ? (
              conflictMatches.map((person: MatchPerson, index: number) => (
                ...
                >
                  <p>
                    名前: {profile?.role === "employee" ? "非表示" : person.name || "不明"}
                  </p>
                  <p>
                    診断結果: {person.mbti || "-"} × {person.businessCode || "-"}
                  </p>
        ...
        <div className="rounded-xl border p-4">
          <h2 className="mb-3 text-xl font-bold">過去のフィードバック</h2>
